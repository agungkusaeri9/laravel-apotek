...
@section('content')
    <div class="container-fluid">
        ...
        <div class="pull-right">
            <a href="{{ route('product-out.index') }}" class="btn btn-warning btn-xs mb-4"><i
        ...
        <div class="row">
            <div class="col-md">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('product-out.update', $item->id) }}" method="post">
                            @csrf
                            @method('patch')
                            ...
                            <div class="form-group">
                                <button class="btn btn-success">Update Barang Keluar</button>
                            </div>
                        </form>
                    </div>
                </div>
