            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0"
                            src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->nama }}" height="400"
                            width="500" /></div>
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5">
                            ...
                            <br>
                            <span>Stok Awal {{ number_format($product->stok_awal, 2) }}</span>
                            <br>
                            <span>Stok Minimal {{ number_format($product->stok_minimal, 2) }}</span>
                            <br>
